...
import { get_deposants, rechercher_deposant_par_telephone } from '../../store/deposantSlice'
                  ...
                  <tr key={index}>
                      ...
                      <td className="align-middle text-center text-sm " style={{ marginLeft: '-10%' }}>
                        <span className="text-xs font-weight-bold">
                          <a className="avatar avatar-xs rounded-circle me-3" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Romina Hadid" >
